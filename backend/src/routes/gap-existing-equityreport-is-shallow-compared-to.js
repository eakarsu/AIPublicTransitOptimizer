...
const FEATURE_SLUG = 'existing-equityreport-is-shallow-compared-to';
const FEATURE_TITLE = 'Existing /equity-report is shallow compared to opportunity';
const PROJECT = 'AIPublicTransitOptimizer';
