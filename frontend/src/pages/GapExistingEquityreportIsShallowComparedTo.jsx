...
export default function GapExistingEquityreportIsShallowComparedTo() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-existing-equityreport-is-shallow-compared-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Existing /equity-report is shallow compared to opportunity</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIPublicTransitOptimizer - Gap feature</p>
