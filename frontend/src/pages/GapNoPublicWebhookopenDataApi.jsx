...
export default function GapNoPublicWebhookopenDataApi() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-webhookopen-data-api', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No public webhook/open data API</h1>
