...
(cd "$PROJECT_DIR/frontend"&&REACT_APP_API_BASE="${REACT_APP_API_BASE:-${REACT_APP_API_URL:-http://127.0.0.1:$BACKEND_PORT}/api}" PORT="$FRONTEND_PORT" BROWSER=none npm start)&CHILD_PIDS+=("$!")
